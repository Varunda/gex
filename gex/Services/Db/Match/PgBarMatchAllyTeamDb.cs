...
namespace gex.Services.Db.Match {
    ...
    public class PgBarMatchAllyTeamDb : IBarMatchAllyTeamDb {

        private readonly ILogger<PgBarMatchAllyTeamDb> _Logger;
        private readonly IDbHelper _DbHelper;
        private readonly IDataReader<BarMatchAllyTeam> _Reader;

        public PgBarMatchAllyTeamDb(ILogger<PgBarMatchAllyTeamDb> logger,
