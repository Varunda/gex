...
namespace gex.Services.Db.Match {
    ...
    public class PgBarMatchTextPingDb : IBarMatchTextPingDb {

        private readonly ILogger<PgBarMatchTextPingDb> _Logger;
        private readonly IDbHelper _DbHelper;

        public PgBarMatchTextPingDb(ILogger<PgBarMatchTextPingDb> logger,
            IDbHelper dbHelper) {
