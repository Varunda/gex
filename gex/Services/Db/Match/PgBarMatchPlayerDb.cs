...
namespace gex.Services.Db.Match {
    ...
    public class PgBarMatchPlayerDb : IBarMatchPlayerDb {

        private readonly ILogger<PgBarMatchPlayerDb> _Logger;
        private readonly IDbHelper _DbHelper;
        private readonly IDataReader<BarMatchPlayer> _Reader;

        public PgBarMatchPlayerDb(ILogger<PgBarMatchPlayerDb> logger,
