...
namespace gex.Services.Db.Match {
    ...
    public class PgBarMatchProcessingPriorityDb : IBarMatchProcessingPriorityDb {

        private readonly ILogger<PgBarMatchProcessingPriorityDb> _Logger;
        private readonly IDbHelper _DbHelper;

        public PgBarMatchProcessingPriorityDb(ILogger<PgBarMatchProcessingPriorityDb> logger,
            IDbHelper dbHelper) {
