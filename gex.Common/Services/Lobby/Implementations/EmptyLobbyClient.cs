...
namespace gex.Services.Lobby.Implementations {
    ...
    public class EmptyLobbyClient : ILobbyClient {
        ...
        public Task<Result<bool, string>> Connect(string host, int port, CancellationToken cancel) {
        ...
        public Task<Result<LobbyMessage, string>> Login(string username, string password, CancellationToken cancel) {
