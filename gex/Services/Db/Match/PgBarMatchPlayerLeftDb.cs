...
namespace gex.Services.Db.Match {
    ...
    public class PgBarMatchPlayerLeftDb : IBarMatchPlayerLeftDb {

        private readonly ILogger<PgBarMatchPlayerLeftDb> _Logger;
        private readonly IDbHelper _DbHelper;

        public PgBarMatchPlayerLeftDb(ILogger<PgBarMatchPlayerLeftDb> logger,
            IDbHelper dbHelper) {
